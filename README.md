...
1. Установите Java 24 если не установлена
2. Скачать дистрибутив Maven с официального сайта Apache Maven (обычно zip-архив):

- Распаковать архив Maven в удобную папку на компьютере.
- Настроить переменные среды Windows:
...
После этих настроек открыть новую командную строку и проверить установку командой, которая должна вывести версию Maven, версию Java и информацию об ОС.
```bash
mvn -version
```
